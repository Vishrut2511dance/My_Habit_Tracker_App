...
class HabitTracker:
    ...
    Attributes:
        ...
        title (str): The name or title of the habit.
        details (str): A more detailed description of the habit.
        recurrence (str): How frequently the habit should be performed (e.g., "Daily", "Weekly").
        date_created (str): The date and time the habit was created.
    ...
    def __init__(self, name: str, description: str, periodicity: str, id: int = None) -> None:
        """
        ...
        Args:
            ...
            id: (Optional) A unique identifier for the habit. If not provided, it will be assigned upon saving to the database.
        """
        self.habit_id = id  # Corrected assignment
        self.name = name
        self.description = description
        self.periodicity = periodicity  # Using 'periodicity' for consistency
    ...
    def delete_from_database(self, db) -> None:
        ...
        cursor.execute("DELETE FROM progress_log WHERE habit_id = ?", (self.habit_id,))  # Assuming 'progress_log' table
        db.commit()